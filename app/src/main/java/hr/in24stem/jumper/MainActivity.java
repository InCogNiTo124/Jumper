...
import hr.in24stem.jumper.bluetooth.BleScanner;
import hr.in24stem.jumper.bluetooth.BleScannerFactory;
import hr.in24stem.jumper.bluetooth.ScanResultsConsumer;
...
//            showMsg(Utility.htmlColorRed("Permission to perform Bluetooth scanning was not yet granted"));
            simpleToast("There was an error", 2000);
        }
    }
...
//    }
    ...
    private void setButtonText() {
        ...
        ((TextView) findViewById(R.id.scanButton)).setText(button_text);
